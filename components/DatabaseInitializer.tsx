  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg max-w-md w-full max-h-[90vh] overflow-auto">
        ...
        <p className="mb-4">
          Choose how you want to store data for the cricket box booking system. You can use local storage (data stored
          in your browser) or set up a Supabase database.
        </p>
